...
User.create([
  { id: 2, first_name: 'Timothy', last_name: 'Palmer', role_ids: [ 1, 2, 4 ], team_id: 2, permission_id: 8, username: 'tpalmer' },
  { id: 3, first_name: 'John', last_name: 'Doe', role_ids: [ 1 ], team_id: 2, permission_id: 2, username: 'jdoe' },
  { id: 4, first_name: 'Jane', last_name: 'Roe', role_ids: [ 1, 2 ], team_id: 1, permission_id: 4, username: 'jroe' },
  { id: 5, first_name: 'Bob', last_name: 'Smith', role_ids: [ 1, 2, 4 ], team_id: 2, permission_id: 8, username: 'rsmith' },
  { id: 6, first_name: 'Justin', last_name: 'Time', role_ids: [ 1, 2, 4 ], team_id: 2, permission_id: 4, username: 'jtime' },
