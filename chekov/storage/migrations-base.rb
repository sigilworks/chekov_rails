...
# rails g scaffold task application:references build_observed:string description:text bz_id:integer reporter:references assignee:references status:references browser:references 
